...
int do_assignments_overlap(assignment assignment_one, assignment assignment_two);
...
int main(void)
{
    ...
    while (fgets(current_line, 20, fp))
    {
        ...
        if (do_assignments_overlap(first_assignment, second_assignment))
        {
            count++;
        }
    }
...
int do_assignments_overlap(assignment assignment_one, assignment assignment_two)
{
    if (assignment_one.end < assignment_two.start || assignment_two.end < assignment_one.start)
    {
        return 0;
    }
